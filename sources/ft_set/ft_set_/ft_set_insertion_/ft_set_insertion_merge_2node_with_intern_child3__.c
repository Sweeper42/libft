...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_set_insertion_merge_2node_with_intern_child3__.c:+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: nperrin <nperrin@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/01/23 12:14:31 by nperrin           #+#    #+#             */
/*   Updated: 2018/01/23 12:17:44 by nperrin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
			...
			t_error_c **hcos_error)
{
	...
	if (!(ps_mid_child = ft_set_node_create_intern_2node__(
		...
		(t_u_set_node *[2]){
			ps_right_child->arpu_child[0],
			ps_right_child->arpu_child[1]
		},
