...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_set_2_intern_node_merge_with_child__.c          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: nelson <nelson@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/12/10 13:32:26 by nelson            #+#    #+#             */
/*   Updated: 2017/12/10 17:42:17 by nelson           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
					...
					t_s_set_intern_node *ps_node_parent)
{
	...
	ps_node_parent->arpcov_elem[2] = ps_node_parent->arpcov_elem[0];
